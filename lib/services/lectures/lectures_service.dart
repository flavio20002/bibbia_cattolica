...
import 'data/feast_fixed.dart';
import 'data/ferial_fixed.dart';
import 'enum/liturgyCategory.dart';
import 'model/liturgyModel.dart';

extension MyDateCompare on DateTime {
  bool isSameDate(DateTime otherDate) =>
      otherDate != null ? this.isAtSameMomentAs(otherDate) : false;
}
...
class LecturesService {
  ...
  static LiturgyEnum _solemnityCalculated(DateTime date, bool isEpiphanyFeast) {
    int year = date.year;
  ...
  static LiturgyModel liturgy(DateTime date, bool isEpiphanyFeast) {
    ...
    if (solemnityCalculatedCategory != null) {
      return new LiturgyModel(
          category: solemnityCalculatedCategory, isFeast: true);
    }
    ...
    LiturgyModel _feastLiturgy = _feast(dateCleaned);
    if (_feastLiturgy != null) {
      return _feastLiturgy;
    }
    LiturgyModel _ferialLiturgy = _ferial(dateCleaned, isEpiphanyFeast);
    if (_ferialLiturgy != null) {
      return _ferialLiturgy;
    }
    return null;
  }
}
